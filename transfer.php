...
<body style="background:url(images/48.jpeg);background-size: 100%">
 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">  <a class="nav-link" href="transfer.php">Transfert de Compte</a></li>
  ...
  <div class="card-body">
      <form method="POST">
          <div class="alert alert-success w-50 mx-auto">
            ...
            <input type="text" name="otherNo" class="form-control " placeholder="Entrer numero du compte beneficiaire" required>
            <button type="submit" name="get" class="btn btn-primary btn-bloc btn-sm my-1">info du compte</button>
          </div>
      </form>
           ...
           $row2 = $array3->fetch_assoc();
            echo "<div class='alert alert-success w-50 mx-auto'>
                  <form method='POST'>
                    ...
                    Saisissez le montant pour le transfert
                    <input type='number' name='amount' class='form-control' min='1' max='$userData[balance]' required>
      ...
      ?>
    <br>
    <h5>Historiques des Transferts</h5>
    <?php
    ...
    if (isset($_POST['transfer']))
    {
      ...
      if ($array ->num_rows > 0) 
      {
         while ($row = $array->fetch_assoc()) 
         {
            ...
            {
              echo "<div class='alert alert-warning'>Le transfert a été effectuer pour Rs.$row[debit] Depuis votre compte chez $row[date] Dans le compte no.$row[other]</div>";
            }

         }
      }
      else
        echo "<div class='alert alert-info'>Vous n'avez effectué aucun transfert pour le moment.</div>";
    ?>  
  </div>
