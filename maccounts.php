 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">  <a class="nav-link" href="maccounts.php">Compte caissier</a></li>
...
<div class="card w-100 text-center shadowBlue">
  ...
  Tous les comptes du personnel <button class="btn btn-outline-success btn-sm float-right" data-toggle="modal" data-target="#exampleModal">Add New Account</button>
  </div>
  <div class="card-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="saveAccount" class="btn btn-primary">Enrégistrer le compte</button>
      </form>
      </div>
    </div>
  </div>
